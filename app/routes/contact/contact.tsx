      ...
      <div className={style.subContactContainer}>
        ...
        <div className={style.contactBox}>
          {/* <div className={style.iconsBox}>
            ...
            <div className={style.iconComponent}>
              <SvgIconHelper name="email" icon={<Email />} pass={'mailto:bgd.draghia@gmail.com'} />
            </div>
            <div className={style.iconComponent}>
              <SvgIconHelper
                name="twitter"
          ...
          <div className={style.formBox}>
            <form action="https://formspree.io/f/mrgdbvbz" method="POST" className={style.form}>
              ...
              <div className={style.formWrap}>
                ...
                <textarea name="message" id="formname" required />
              </div>
